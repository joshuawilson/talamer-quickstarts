...
module('The main App', {
    setup: function() {
        ...
        $fixture.append(
            '<div><ul id="contacts-display-listview" class="contacts-list"></ul></div>' +
            '<div><ul id="contacts-display-detail-listview" class="contacts-list"></ul></div>'
        );
    },
    teardown: function() {
        // run after
...
test('should be able to add 2 rows to both a simple list view and a detailed list view. ', 2, function() {
    var contacts = [{email: "jane.doe@company.com", id: 14, firstName: "Jane", lastName: 'Doe', phoneNumber: "11231231231", birthDate:'1966-01-03'},
                    {email: "john.doe@company.com", id: 15, firstName: "John", lastName: 'Doe', phoneNumber: "12125551212", birthDate:'1978-02-23'}];
...
test('should be able to fill in the edit form with values', 5, function() {
    var $fixture = $( "#qunit-fixture" );
    var buildEdit = CONTACTS.edit.buildContactDetail;
    var contact = {email: "jane.doe@company.com", id: 14, firstName: "Jane", lastName: 'Doe', phoneNumber: "12341231231", birthDate:'1966-01-03'};
    ...
    strictEqual($('#contacts-edit-input-tel').val(),       '1 234-123-1231', 'Expected to find 1 234-123-1231 in the phone number field.');
